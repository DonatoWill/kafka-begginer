...
public class TwitterProducer {
    ...
    List<String> terms = Lists.newArrayList("kafka", "java", "technology", "kotlin");
    ...
    public void run(){
        ...
        // Create twittter client
        Client client = createTwitterClient(msgQueue);
        // Attemps to establish a connection
        client.connect();
        ...
        while (!client.isDone()) {
            ...
            if(msg != null){
                logger.info(msg);
                producer.send(new ProducerRecord<>("twiter-producer", null, msg), new Callback() {
                    @Override
